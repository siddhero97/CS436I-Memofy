...
export default class FridgeRoutes {
    ...
    public fetchFridgeService: FetchFridgesService = new FetchFridgesService();
    ...
    routes() {
        this.router.get('/get/all', passport.authenticate('jwt', {session: false}), this.fetchFridgeService.execute);
